	...
	u8 ht, bool started)
{
...
#if (((LINUX_VERSION_CODE >= KERNEL_VERSION(5, 15, 0)) && defined(CONFIG_AW_KERNEL_AOSP)) || (LINUX_VERSION_CODE > KERNEL_VERSION(5, 19, 0)))
										, 0
#endif
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 11, 0))
										, false
#endif
#if (((LINUX_VERSION_CODE >= KERNEL_VERSION(5, 15, 94)) && defined(CONFIG_AW_KERNEL_AOSP)) || (LINUX_VERSION_CODE > KERNEL_VERSION(6, 2, 0)))
										, 0
#endif
										);
		goto exit;
	...
	cfg80211_ch_switch_notify(adapter->pnetdev,
			&chdef
#if (((LINUX_VERSION_CODE >= KERNEL_VERSION(5, 15, 0)) && defined(CONFIG_AW_KERNEL_AOSP)) || (LINUX_VERSION_CODE > KERNEL_VERSION(5, 19, 0)))
            , 0
#endif
...
#if (((LINUX_VERSION_CODE >= KERNEL_VERSION(5, 15, 41)) && defined(CONFIG_AW_KERNEL_AOSP)) || (LINUX_VERSION_CODE > KERNEL_VERSION(5, 19, 0)))
	, int link_id
#endif
	, u8 key_index
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 37)) || defined(COMPAT_KERNEL_RELEASE)
...
static int cfg80211_rtw_stop_ap(struct wiphy *wiphy
		, struct net_device *ndev
#if (((LINUX_VERSION_CODE >= KERNEL_VERSION(5, 15, 0)) && defined(CONFIG_AW_KERNEL_AOSP)) || (LINUX_VERSION_CODE > KERNEL_VERSION(5, 19, 0)))
